...
param keyVaultName = 'kv-vsample-dev-sre-eau'
param functionPlanName = 'plan-dev'
param functionAppName = 'v-sre-sample-python-dev-eau'
...
param servicePrincipalId = '3816e506-8e5a-4ae3-8662-8c6dfa570336'
